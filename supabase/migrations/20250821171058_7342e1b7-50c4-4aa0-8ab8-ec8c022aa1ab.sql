...
-- Set rama.k@amensys.com as the only super admin by demoting others first
...
-- Ensure rama.k@amensys.com has super_admin role (insert if not exists)
INSERT INTO public.user_roles (user_id, role, app_type) 
SELECT user_id, 'super_admin'::app_role, 'calendar'::app_type
